...
public class PanelListaPacientes extends JPanel implements ActionListener, ListSelectionListener {
    ...
    /**
     * Bot�n para insertar un paciente
     */
    private JButton botonAgregar;

    /**
     * Bot�n para eliminar un paciente
     */
    ...
    public PanelListaPacientes(InterfazCentralPacientes ventana) {
        ...
        botonAgregar.setIcon(new ImageIcon("CentralDePacientes/data/nuevo.gif"));
        ...
        botonBuscar.setIcon(new ImageIcon("CentralDePacientes/data/buscar.gif"));
        ...
        botonEliminar.setIcon(new ImageIcon("CentralDePacientes/data/eliminar.gif"));
    ...
    /**
     * Muestra la informaci�n del paciente seleccionado
     *
     * @param e El evento de cambio del �tem seleccionado en la lista
     */
