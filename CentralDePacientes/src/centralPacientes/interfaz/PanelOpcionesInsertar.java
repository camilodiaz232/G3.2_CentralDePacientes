...
public class PanelOpcionesInsertar extends JPanel implements ActionListener {
    ...
    public PanelOpcionesInsertar(DialogoOpcionesInsertar diag) {
        ...
        botonAntes = new JRadioButton("Antes del paciente con c�digo");
        ...
        botonContinuar.setIcon(new ImageIcon("CentralDePacientes/data/continuar.gif"));
        ...
        botonCancelar.setIcon(new ImageIcon("CentralDePacientes/data/cancelar.gif"));
